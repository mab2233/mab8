...
💡 **ғɪɴᴅ ᴏᴜᴛ ᴀʟʟ ᴛʜᴇ ʙᴏᴛ's ᴄᴏᴍᴍᴀɴᴅs ᴀɴᴅ ʜᴏᴡ ᴛʜᴇ ᴡᴏʀᴋ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ » 📚 ᴅᴀᴠ ʙᴇᴋᴏ ʙᴜᴛᴛᴏɴ !**

❓ **ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀʟʟ ғᴇᴀᴛᴜʀᴇ ᴏғ ᴛʜɪs ʙᴏᴛ, ᴊᴜsᴛ ᴛʏᴘᴇ /help**

✂ **ɪ ᴡᴀs ᴍᴀᴅᴇ ʙʏ ᴍᴀʙ & ᴜғᴏ ғᴏʀ ᴘʟᴀʏɪɴɢ ᴍᴜsɪᴄ ᴏɴ ᴅᴀᴍᴀʀ**
</b>""",
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    InlineKeyboardButton(
                        "★ 𝗗𝗘𝗩 𝗠𝗔𝗕 ★", url="https://t.me/xO_mab_Ox"
                ],[
                    InlineKeyboardButton(
                         "★ 𝗗𝗔𝗩 𝗕𝗘𝗞𝗢 ★", url="https://t.me/D_M_BEKO"
                    ),
                    InlineKeyboardButton(
                        "★ 𝗗𝗔𝗩 𝗡𝗔𝗕𝗶𝗟 ★", url="https://t.me/D_M_NABIL")
                ],[
                    InlineKeyboardButton(
                        "👥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ", url="https://t.me/TEM_DAMAR1"
                    ),
                    InlineKeyboardButton(
                        "📣 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ", url="https://t.me/t.me/mab_x2")               
                 ],[
                    InlineKeyboardButton(
                        "➕ ضيف البوت لي مجموعتك من هنا ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
                    )
                ]
            ]
        ),
...
/gcast - send a broadcast message trought the assistant
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "♞🏻‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ", url=f"https://t.me/xO_mab_Ox"
                    )
                ]
            ]
        )
